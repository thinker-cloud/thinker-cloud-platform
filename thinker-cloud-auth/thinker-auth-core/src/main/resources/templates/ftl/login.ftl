...
<div
	...
	<div class="flex justify-center self-center  z-10">
		<div class="p-12 bg-white mx-auto rounded-3xl w-96 ">
			...
			<form class="form-signin" action="/auth/oauth2/token" method="post">
				<input type="hidden" name="client_id" class="form-control" value="thinker" placeholder="所属客户端">
			...
			<div class="mt-7 text-center text-gray-300 text-xs">
                ...
                <a href="#" rel="" target="_blank" title="Codepen aji"
                   class="text-purple-500 hover:text-purple-600 ">Thinker Cloud</a></span>
			</div>
		</div>
	</div>
</div>
