    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-5">
            <p class="navbar-text navbar-right">
                <a target="_blank" href="https://isexceuse.com">技术支持</a>
            </p>
            <p class="navbar-text navbar-right">
                <a target="_blank" href="https://isexceuse.com">${user.username}</a>
            </p>
        </div>
    </div>
</nav>
...
<footer>
    <p>support by: www.isexceuse.com</p>
    <p>email: <a href="mailto:isexceuse@gmail.com">isexceuse@gmail.com</a>.</p>
</footer>
</body>
</html>
